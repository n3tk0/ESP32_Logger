...
R"HTML(<div class="card"><div class="card-header">&#x1F50C; Sensors &mdash; Enable / Disable</div><div class="card-body" style="padding:4px 18px 14px"><div id="cl-slist"><span style="color:#718096;font-size:.85rem">Loading&hellip;</span></div></div></div><div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:16px"><button class="btn btn-primary" onclick="fsClSave()">&#x1F4BE; Save &amp; Restart</button><button class="btn btn-warn" onclick="fsClLoad()">&#x21BA; Reload</button><span id="cl-msg" class="msg"></span></div></div></div>)HTML"
R"HTML(<script>
