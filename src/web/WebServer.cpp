...
R"HTML(<header><h1>&#x1F4A7; Water Logger <span class="badge">SETUP MODE</span></h1><div class="sub">Upload UI files to /www/ to restore normal operation &mdash; or bookmark <strong>/setup</strong> for recovery</div></header><div class="container"><div class="tabs"><button class="tab active" id="tab-btn-setup" onclick="switchTab('setup',this)">&#x2699;&#xFE0F; Setup</button><button class="tab" id="tab-btn-corelogic" onclick="switchTab('corelogic',this)">&#x1F9E9; Core Logic</button></div>)HTML"
...
R"HTML(<div class="card"><div class="card-header"><span>&#x1F50C; Sensors</span><button class="btn btn-sm btn-primary" onclick="fsClAddSensor()">+ Add Sensor</button></div><div class="card-body" style="padding:4px 18px 14px"><div id="cl-slist"><span style="color:#718096;font-size:.85rem">Loading&hellip;</span></div></div></div><div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:16px"><button class="btn btn-primary" onclick="fsClSave()">&#x1F4BE; Save &amp; Restart</button><button class="btn btn-warn" onclick="fsClLoad()">&#x21BA; Reload</button><span id="cl-msg" class="msg"></span></div></div></div>)HTML"
R"HTML(<script>
