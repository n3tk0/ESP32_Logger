...
var FS_PCFG=null;
var FS_SENSOR_TYPES=[{value:'bme280',label:'BME280',iface:'i2c'},{value:'sds011',label:'SDS011',iface:'uart'},{value:'pms5003',label:'PMS5003',iface:'uart'},{value:'yfs201',label:'YF-S201 (flow)',iface:'pulse'},{value:'ens160',label:'ENS160',iface:'i2c'},{value:'sgp30',label:'SGP30',iface:'i2c'},{value:'rain',label:'Rain gauge',iface:'pulse'},{value:'wind',label:'Wind speed',iface:'pulse'},{value:'zmpt101b',label:'ZMPT101B (AC voltage)',iface:'analog'},{value:'zmct103c',label:'ZMCT103C (AC current)',iface:'analog'}];
